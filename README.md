...
```bash
make sub ARGS="-m client -e tcp/192.168.50.30:7447"
```
...
```bash
# ROS 2 ターミナルで実行
python3 tools/zenoh_to_ros2.py -e tcp/192.168.50.30:7447
...
export ZENOH_CONFIG_OVERRIDE='mode="client";connect/endpoints=["tcp/192.168.50.30:7447"]'
